...
<html>
    ...
    <body>
        <div class="container">
            ...
            <div class="jumbotron" style='padding-bottom: 15px; padding-left: 15px;'>
                ...
                <div id='jqxWidget' style=" font-size: 13px; font-family: Verdana;">
                  ...
                  <div id='listChat' style='min-height: 150px' >
                    <c:forEach items="${messageList}" var="message">
                        <br>
                        <div id="chat">
                             <p><c:out value="${message.date}"/> - <font color="red"><c:out value="${message.pseudo}"/> </font> :  <c:out value="${message.contenu}"/> </p>
                        </div>
                    </c:forEach>
                </div>
                    </div>
